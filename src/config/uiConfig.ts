...
export const UI_DEFAULTS: UiState = {
  ...
  panels: {
    "panel-api-key":           { hidden: false, label: "API Key",             tab: "ai-config" },
    "panel-connection":        { hidden: false, label: "Connection Test",      tab: "ai-config" },
    "panel-tier":              { hidden: false, label: "Plan Tier",            tab: "ai-config" },
    "panel-model":             { hidden: false, label: "Model",                tab: "ai-config" },
    "panel-inference":         { hidden: false, label: "Inference Parameters", tab: "ai-config" },
    "panel-multiturn":         { hidden: false, label: "Multi-Turn Chunking",  tab: "ai-config" },
    "panel-instructions":      { hidden: false, label: "Custom Instructions",  tab: "ai-config" },
    "panel-usage":             { hidden: false, label: "Usage Monitor",        tab: "ai-config" },
    "panel-debug-connection":  { hidden: true,  label: "Connection Debug Log", tab: "ai-config" },
    "panel-default-api-key":   { hidden: false, label: "Default API Key",      tab: "app-config" },
    "panel-locale":            { hidden: false, label: "Locale",               tab: "app-config" },
